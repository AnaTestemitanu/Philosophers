...
# define USAGE_MESSAGE "%s usage: ./philosophers <number_of_philosophers> \
<time_to_die> <time_to_eat> <time_to_sleep> \
[number_of_times_each_philosopher_must_eat]\n"
# define ERROR_INVALID_INPUT_DIGIT "%s invalid input: %s: \
not a valid unsigned integer between 0 and 2147483647.\n"
# define ERROR_INVALID_INPUT_RANGE "%s invalid input: \
...
t_dining_table  *init_dining_table(int argc, char **argv, int index);
...
void            philosopher_sleep(t_dining_table *dining_table, time_t sleep_duration);
